...
module.exports = msgHndlr = async (aksa, message) => {
    try {
        ...
        const apiKey = 'QkKbhxteu6CssWuGRIxG' // apikey you can get it at https://mhankbarbarss.herokuapp.com/api
        const vhtear = 'siregar2k99HHftel' // apikey from vhtear
        ...
        const ownerNumber = ["628127668234@c.us", "6283184023519@c.us"] // replace with your whatsapp number
        ...
        if (args.includes('@6283184023519')) { //replace with your bot number
...
Twitter: https://twitter.com/bdrsmsdn`)
                ...
                case `${prefix}owner`:
                    if (!isRegis) return aksa.reply(dari, `Maaf ${pushname}, sepertinya kamu belum terdaftar sebagai user Lucya, untuk pendaftaran bisa menggunakan *!regis* |nama|no hp. Contoh: !regis |${pushname}|${serial.replace(/@c.us/g,'')}`, id)
                    aksa.sendContact(dari, '628127668234@c.us') //ganti
                    break
